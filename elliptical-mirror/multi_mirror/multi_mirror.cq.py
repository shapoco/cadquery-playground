...
class FocusIndicator:
    def __init__(self, ref: Reflector):
        # 内側の足の座標
        ...
        arrow_thickness = 1
        arrow_size = 2
        arrow_space_size = arrow_size + 5
        arrow_body_size = arrow_space_size + 5
        verts = [
...
step.export(f"{STEP_OUT_DIR}/reflector.step")
